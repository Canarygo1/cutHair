...
class _ConfirmScreenState extends State<ConfirmScreen> implements ConfirmView {
  ...
  Widget getConfirmScreen() {
    if (appointment.business.typeBusiness == "Peluquerías") {
      return ConfirmScreenHairDressing().getConfirmHairDressing(appointment, this.HEIGHT, this.WIDHT, penalize, context, this.appointment.business.typeBusiness, buttonConfirm(), buttonCancel());
    } else if (appointment.business.typeBusiness == "Restaurantes") {
      return ConfirmScreenRestaurant().getConfirmRestaurant(appointment, this.HEIGHT, this.WIDHT, penalize, context, this.appointment.business.typeBusiness, buttonConfirm(), buttonCancel());
    } else {
      return ConfirmScreenBeach().getConfirmBeach(appointment, this.HEIGHT, this.WIDHT, penalize, context, this.appointment.business.typeBusiness, buttonConfirm(), buttonCancel());
    }
  }
